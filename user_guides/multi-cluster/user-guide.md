...
* create net tunnel tunnel vxlan-tunnel-dev key 1 profile fl-vxlan local-address 10.1.1.245
...
* create net tunnel tunnel vxlan-tunnel-prod key 11 profile fl-vxlan local-address 10.1.1.245
